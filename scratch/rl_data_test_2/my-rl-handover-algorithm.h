...
#ifndef MY_RL_HANDOVER_ALGORITHM_H
#define MY_RL_HANDOVER_ALGORITHM_H
...
/**
 * \brief Handover algorithm implementation based on RSRQ measurements, Event My
 *
 ...
 */
class MyRlHandoverAlgorithm : public LteHandoverAlgorithm
{
public:
  /// Creates an A2-A4-RSRQ handover algorithm instance.
  MyRlHandoverAlgorithm ();

  virtual ~MyRlHandoverAlgorithm ();
  ...
  friend class MemberLteHandoverManagementSapProvider<MyRlHandoverAlgorithm>;
...
private:
   ...
   */
  uint8_t m_neighbourCellThreshold;
...
}; // end of class MyRlHandoverAlgorithm
